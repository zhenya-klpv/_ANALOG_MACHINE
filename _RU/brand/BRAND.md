# Brand — Analog Machine

> **Ядро бренда:** Analog Machine · **Handbuilt in California**

Три смысла в одной связке:

| Слово | Значение |
|-------|----------|
| **Analog** | Не digital appliance — механический объект |
| **Machine** | Настоящая машина, не гаджет |
| **Handbuilt in California** | Ремесло, место, культура — Highway 9, Skyline, Pacific Coast |

> Мы строим **аналоговые машины вручную в Калифорнии**.

Не «мы делаем BMW». Не «мы лучше BMW» — **наша интерпретация платформы**.
...
|---------|----------|
| **Brand** | Analog Machine |
| **Studio / legal** | Analog Machine Works · Analog Machine Works LLC |
| **Cars** | AM36 · AM39 · AM Touring |
| **Badge** | AM |
| **Signature** | **Handbuilt in California** |
| **Philosophy** | Mechanical cars for the digital age |

### Для людей → **Analog Machine**  
### Для документов → **Analog Machine Works**

**Не использовать:** garage, customs, tuning, performance shop, **built by hands** (грамматика).

**На машине писать:**
- ✅ *Handbuilt in California*
- ✅ *Built by hand in California*
- ❌ *built by hands*

*Handbuilt* — Porsche / Singer / coachbuilt культура. Короче, дороже — идеально для шильдика.

---

## Copy system

### Бренд + подпись (основной lockup)
...
### Philosophy (видео, engine cover, about)

> Mechanical cars for the digital age.

### Полная фраза (сайт, press)

> Analog Machine builds mechanical cars by hand in California — modern classics made for feel, presence, and motion.

### Product line (AM36)

> **AM36** by Analog Machine  
> A handbuilt California interpretation of the BMW E36.

Не «лучше BMW» — **своя интерпретация**. Очень правильный тон.

### Video tagline (альтернатива)

> Built by hand. Made for feel.

---

## Формулировки — сравнение

| Фраза | Использование |
|-------|---------------|
| **Handbuilt in California** | **Фаворит** — шильдик, badge, короткая подпись |
| Built by hand in California | Длинная форма, сайт, narrative |
| Hand-built in California | Формально; чуть менее чисто визуально |
| Crafted by hand in California | Люкс; может звучать jewelry/furniture |
| Analog machines, built by hand in California. | Готовая фраза для сайта / hero |

---

## Rolex vs Apple Watch

Не «старое лучше нового». **Аналоговая вещь может быть дороже, желаннее, эмоциональнее цифровой.**
...
## Автомобиль как продукт

| Не | Да |
|----|-----|
| BMW E36 restomod | **AM36** by Analog Machine |
| Тюнинг BMW | Handbuilt California interpretation |
| E36 + carbon hood | **Analog Machine 36** · based on BMW E36 |

---

## Badge & plaque system

Не копировать BMW roundel.

| Место | Copy |
|-------|------|
| Спереди | **AM** — круглый или овальный badge |
| Сзади | **ANALOG MACHINE** |
| Порог | **AM36 No. 001** |
| Салон (табличка) | **Handbuilt in California** |
| Build plate (вариант A) | **ANALOG MACHINE** · No. 001 · **Handbuilt in California** |
| Build plate (вариант B) | **AM36 No. 001** · Built by Analog Machine · California |
| Engine cover | *Mechanical cars for the digital age* |
| Build book | ANALOG MACHINE No. 001 · Built by Analog Machine Works |

---

## Проекты

| Build ID | Public name | Plate |
|----------|-------------|-------|
| e36-00 | AM36 · Analog Machine 36 | No. 001 |
| future | AM39 · AM Touring | No. 002+ |
...
**Philosophy line (ниже или отдельно):**
```
Mechanical cars for the digital age.
```

**Studio credit (footer, build book):**
```
Built by Analog Machine Works
California
```
...
| | |
|---|---|
| Instagram | **@analogmachineworks** (`@analogmachine` занят) |
| Website | **analogmachine.co** |
| Bio | Handbuilt mechanical cars in California · AM36 No. 001 in progress |

Подробно: [`SOCIAL.md`](SOCIAL.md)

---

## Visual concepts

AM36 moodboard / AI concepts: [`visual/am36-concepts/`](visual/am36-concepts/)  
Реальные фото билда: `builds/e36-00/content/photos/`

---

## Visual identity (TBD)

- [x] AM36 concept renders — `visual/am36-concepts/`
- [ ] Wordmark: ANALOG MACHINE
- [ ] Signature line: Handbuilt in California
- [ ] Monogram: AM
- [ ] Badge AM
- [ ] Типографика plaques
- [ ] Instagram @analogmachineworks + avatar
- [ ] LLC — bootstrap Phase 3+
